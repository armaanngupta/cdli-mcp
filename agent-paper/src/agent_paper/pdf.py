...
# Appears in the footer of every page, not just the first, so an excerpted page still
# carries it. Working wording — still to be confirmed by CDLI, who may also want a contact
# or URL added. Changing the length matters: the footer frame is 1.4cm and silently clips.
AI_DISCLOSURE = (
    "This document was generated by an automated AI research assistant from the CDLI "
    "catalogue and may contain errors. Verify all readings and citations against the "
    "linked CDLI records before use. This is not a CDLI publication and has not been "
    "peer reviewed."
)
# ----------------------------------------------------------------------------------------
